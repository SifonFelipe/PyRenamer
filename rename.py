...
def rename_files(directory, prefix):
    ...
    """
    files = [filename for filename in os.listdir(directory) if is_file(directory, filename)] #split files from directories
...
directory_path = str(input('Enter the path of your directory (you can use ./):\n'))
